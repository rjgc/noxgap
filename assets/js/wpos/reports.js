...
function WPOSReports() {
    ...
    this.generateTakingsReport = function () {
        var html = reportheader("Relatório de Pagamentos") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>Método</th><th># Pagamentos</th><th>Valores</th><th># Reembolsos</th><th>Reembolsos</th><th>Balanço</th></tr></thead><tbody>';
    ...
    this.generateWhatsSellingReport = function () {
        var html = reportheader("Relatório Artigos Vendidos") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>Artigo</th><th># Un Vendidas</th><th>Total</th></tr></thead><tbody>';
    ...
    this.generateSellerReport = function () {
        var html = reportheader("Relatório de Vendedor") + '<table style="width:100%;" class="table table-stripped"><thead><tr><th>User</th><th>Vendas</th><th>Anulações</th><th>Reembolsos</th><th>Balanço</th></tr></thead><tbody>';
